var provice = [
    ...
    },
    {
        ...
        city: [
            {
                name: "台北",
                districtAndCounty: ["台北"]
            },
            {
                name: "高雄",
                districtAndCounty: ["高雄"]
            },
            {
                name: "台中",
                districtAndCounty: ["台中"]
            },
            {
                name: "花莲",
                districtAndCounty: ["花莲"]
            },
            {
                name: "基隆",
                districtAndCounty: ["基隆"]
            },
            {
                name: "嘉义",
                districtAndCounty: ["嘉义"]
            },
            {
                name: "金门",
                districtAndCounty: ["金门"]
            },
            {
                name: "连江",
                districtAndCounty: ["连江"]
            },
            {
                name: "苗栗",
                districtAndCounty: ["苗栗"]
            },
            {
                name: "南投",
                districtAndCounty: ["南投"]
            },
            {
                name: "澎湖",
                districtAndCounty: ["澎湖"]
            },
            {
                name: "屏东",
                districtAndCounty: ["屏东"]
            },
            {
                name: "台东",
                districtAndCounty: ["台东"]
            },
            {
                name: "台南",
                districtAndCounty: ["台南"]
            },
            {
                name: "桃园",
                districtAndCounty: ["桃园"]
            },
            {
                name: "新竹",
                districtAndCounty: ["新竹"]
            },
            {
                name: "宜兰",
                districtAndCounty: ["宜兰"]
            },
            {
                name: "云林",
                districtAndCounty: ["云林"]
            },
            {
                name: "彰化",
                districtAndCounty: ["彰化"]
            }
		]
    }
];